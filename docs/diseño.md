...
**Fase 2A — cross-canasta exacto por segmentos (implementado).** Para todo tipo content-exact (mismo conjunto de categorías y ningún genérico cruza de bucket en las 3 juntas) la fila cross se calcula exacta:
